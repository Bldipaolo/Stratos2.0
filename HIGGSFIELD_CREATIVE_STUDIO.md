...
higgsfield generate create gpt_image_2 \
  --prompt "Premium editorial ad key art for Stratos AI, boutique medspa front desk after hours, near-black and ink-green environment with deep green #145838/#247E4F structure, #55AE74 signal accents, warm white/cream overlay space, and restrained gold highlights, a phone showing a consult request routed into an AI concierge workflow, cinematic lighting, realistic luxury clinic details, no fake logos, no readable tiny text, high-end agency aesthetic." \
  --aspect_ratio 9:16 \
  --resolution 2k \
  --wait \
  --wait-timeout 20m \
...
```bash
higgsfield generate create gpt_image_2 \
  --prompt "Premium B2B operations visual for Stratos AI: fragmented local business tools represented as separate near-black and ink-green glass panels slowly connecting into one clean command flow, deep green and #55AE74 signal lines with restrained gold highlights, white negative space for typography overlay, no clutter, no fake brand marks, dramatic but minimal." \
  --aspect_ratio 1:1 \
  --resolution 2k \
  --wait \
  --wait-timeout 20m \
...
```bash
higgsfield generate create marketing_studio_video \
  --prompt "Polished commercial for Stratos AI showing a local business losing after-hours leads, then switching to a premium website plus AI intake and follow-up system. Modern original Stratos black/ink/green brand mood with #145838/#247E4F/#55AE74 accents and warm white/cream type cards, serious, high-trust, no hype, end with: Your website should act like your best operator." \
  --mode tv_spot \
  --duration 15 \
  --resolution 720p \
  --aspect_ratio 9:16 \
...
- consistent original Stratos palette: #030605/#0A100D base, #145838/#247E4F/#55AE74 accents, #F8FAF6/#EEF0E8 text, #D3C7A0 highlights
