...
['Boca Lead War Room','Hyper-Specific Demo Sites','One-Click Outreach Packs','Audit → Demo → Pitch','MedSpa Domination Pack','Revenue Forecast Simulator','Morning Briefing','Proof Vault','Public Portfolio Page','Client Close Room','Usage Saver'].forEach(label=> assert(js.includes(label), `missing module ${label}`));
